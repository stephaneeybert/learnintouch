...
class LexiconEntryDB {
  ...
  function LexiconEntryDB() {
    ...
    $this->tableName = DB_TABLE_LEXICON_ENTRY;

    $this->dao = new LexiconEntryDao($this->dataSource, $this->tableName);
  }
  ...
  function insert($object) {
    ...
    return($this->dao->insert($object->getName(), $object->getExplanation(), $object->getImage()));
  }
  ...
  function update($object) {
    ...
    return($this->dao->update($object->getId(), $object->getName(), $object->getExplanation(), $object->getImage()));
  }
