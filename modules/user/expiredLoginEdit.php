...
if ($formSubmitted) {
  ...
  if ($isPhone) {
    $userUtils->setPhoneExpiredLoginPage($languageCode, $url);
    } else {
    $userUtils->setComputerExpiredLoginPage($languageCode, $url);
    }
  ...
  if ($isPhone) {
    $url = $userUtils->getPhoneExpiredLoginPage($languageCode);
    } else {
    $url = $userUtils->getComputerExpiredLoginPage($languageCode);
    }
