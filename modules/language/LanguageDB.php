...
class LanguageDB {
  ...
  function __construct() {
    ...
    $this->dao = new LanguageDao($this->dataSource, $this->tableName);
  }
  ...
  function insert($object) {
    ...
    return($this->dao->insert($object->getCode(), $object->getName(), $object->getLocale(), $object->getImage()));
  }
  ...
  function update($object) {
    ...
    return($this->dao->update($object->getId(), $object->getCode(), $object->getName(), $object->getLocale(), $object->getImage()));
  }
