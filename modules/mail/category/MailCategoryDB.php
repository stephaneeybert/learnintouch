...
class MailCategoryDB {

  var $dataSource;
  var $tableName;
  var $dao;

  function MailCategoryDB() {
    global $gSqlDataSource;

    $this->dataSource = $gSqlDataSource;

    $this->tableName = DB_TABLE_MAIL_CATEGORY;

    $this->dao = new MailCategoryDao($this->dataSource, $this->tableName);
    }
