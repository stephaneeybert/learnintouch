...
[  10]Il est possible d'importer des cours d'un site web.\n\nLa liste affiche tous les cours qui peuvent être importés depuis un site web.\n\nLe site web doit d'abord être enregistré comme un site web exportateur.\n\nLors de l'import d'un cours, le cours lui même et tout son contenu est importé.\n\n\n\nSi aucun cours n'est sélectionné alors la liste de tous les cours est affichée.\n\nDans ce cas, il est possible d'importer n'importe quel cours avec toutes ses leçons et tous ses exercices.\n\nSi un cours est sélectionné alors ses leçons et ses exercices sont affichés.\n\nDans ce cas, il est possible d'importer n'importe quelle leçon ou n'importe quel exercice du cours sélectionné.
[  11]Element de cours
...
[  23]Importer un cours ainsi que toutes ses leçons et tous ses exercices
[  24]Importer une leçon ou un exercice du cours sélectionné
