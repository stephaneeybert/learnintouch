...
$str .= "<form action='$gElearningUrl/exercise/display_exercises.php' method='post'>";
...
} else if (isset($elearningExercises)) {

  foreach ($elearningExercises as $elearningExercise) {
    $elearningExerciseId = $elearningExercise->getId();
    $strName = "<a href='$gElearningUrl/exercise/display_exercise.php?elearningExerciseId=$elearningExerciseId' $gJSNoStatus title='$websiteText[14]'><img border='0' src='$gImagesUserUrl/" . IMAGE_ELEARNING_EXERCISE . "' title='$websiteText[13]' style='vertical-align:middle;'> " . $elearningExercise->getName() . "</a>";
    $description = $elearningExercise->getDescription();
    $str .= "<div>$strName</div>";
  }
