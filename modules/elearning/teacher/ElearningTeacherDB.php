...
class ElearningTeacherDB {

  var $dataSource;
  var $tableName;
  var $dao;

  function ElearningTeacherDB() {
    global $gSqlDataSource;

    $this->dataSource = $gSqlDataSource;

    $this->tableName = DB_TABLE_ELEARNING_TEACHER;

    $this->dao = new ElearningTeacherDao($this->dataSource, $this->tableName);
  }
