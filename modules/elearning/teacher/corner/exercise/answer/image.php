...
$str .= "\n<form name='edit' id='edit' action='$gElearningUrl/teacher/corner/exercise/answer/image.php' method='post' enctype='multipart/form-data'>";
...
$str .= "\n<div class='system_field'>" . $fileUploadUtils->getFileSizeMessage($elearningAnswerUtils->imageFileSize). "</div>";
...
$str .= "\n<input type='hidden' name='max_file_size' value='" . $elearningAnswerUtils->imageFileSize . "' />";
