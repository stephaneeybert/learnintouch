...
$str .= "\n<form name='edit' id='edit' action='$gElearningUrl/teacher/corner/exercise/image.php' method='post' enctype='multipart/form-data'>";
...
$str .= "\n<div class='system_field'>" . $fileUploadUtils->getFileSizeMessage($elearningExerciseUtils->imageFileSize). "</div>";
