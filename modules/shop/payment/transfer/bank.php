...
foreach ($languages as $language) {
  ...
  $strCommand = ''
    . " <a href='$gShopUrl/payment/transfer/bank_edit.php?languageCode=$languageCode' $gJSNoStatus>"
  ...
  if ($adminModuleUtils->moduleGrantedToAdmin(MODULE_PHONE_MODEL)) {
    ...
    $strCommand = ''
      . " <a href='$gShopUrl/payment/transfer/bank_edit.php?languageCode=$languageCode&amp;isPhone=1' $gJSNoStatus>"
      . "<img border='0' src='$gCommonImagesUrl/$gImageEdit' title='$mlText[2]'></a>";
