...
function moveTagSelector()
  ...
  var sTagSelTop="<table unselectable=on ondblclick='"+this.oName+".moveTagSelector()' width='100%' cellpadding=0 cellspacing=0><tr style='background:#e9e8f2;font-family:arial;font-size:10px;color:black;'>"+
    ...
    "<img src='"+this.scriptPath+this.iconPath+"decrease.gif' style='cursor:pointer;vertical-align:middle;' onclick='"+this.oName+".changeHeight(-50)'>" +
    "<img src='"+this.scriptPath+this.iconPath+"increase.gif' style='cursor:pointer;vertical-align:middle;margin-right:3px' onclick='"+this.oName+".changeHeight(50)'>"
    "</td></tr></table>";
...
function windowOpen(url,width,height)
  ...
  oUtil.activeModalWin = window.open(url,"","top="+top+"px,left="+left+"px,width="+width+"px,height="+height+"px;toolbar=no,menubar=no,location=no,directories=no,status=yes,resizable=yes,scrollbars=yes")
  window.onfocus = function(){
    try {
      if (oUtil.activeModalWin.closed == false){oUtil.activeModalWin.focus();};
    } catch(e) {}
  };
  }
