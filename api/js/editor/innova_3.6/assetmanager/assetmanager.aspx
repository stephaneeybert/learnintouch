...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        body{font-family:verdana;font-size:11px;color:#555555;background:#ecedef;margin:12px}
    ...
    function doOK()
        ...
        //if(navigator.appName.indexOf('Microsoft')!=-1) window.returnValue=sURL;
        //else 
        window.opener.setAssetValue(sURL);
        self.close();
        }
   </script>
</head>
...
<asp:Panel ID="panelManager" runat="server">
    ...
    <asp:Button ID="btnOk" meta:resourcekey="btnOk" runat="server" Text="    OK    " OnClientClick="doOK();return false;" />
