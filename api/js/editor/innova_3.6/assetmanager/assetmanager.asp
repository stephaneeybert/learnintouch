...
function getAction(isUpload)//NEW 2.4
  ...
  if(sQueryString.indexOf("=")==-1)
    {//no querystring
    sAction="assetmanager.asp?ffilter="+document.getElementById("selFilter").value;
    }
  else
    {
    sAction="assetmanager.asp?"+sQueryString+"&ffilter="+document.getElementById("selFilter").value
    }
